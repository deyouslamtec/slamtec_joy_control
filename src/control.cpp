...
slamtec_joy::slamtec_joy() 
{
   ...
   sub = n.subscribe<sensor_msgs::Joy>("joy",10,&slamtec_joy::callback,this); //订阅手柄发来的数据
} 

void slamtec_joy::callback(const sensor_msgs::Joy::ConstPtr& Joy) //键值回调函数
 {
